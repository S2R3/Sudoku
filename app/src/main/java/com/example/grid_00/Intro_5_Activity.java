...
public class Intro_5_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        play = (Button) findViewById(R.id.intro_5_play);
        return_back = (Button) findViewById(R.id.intro_5_return);
        next = (Button) findViewById(R.id.intro_5_next);
