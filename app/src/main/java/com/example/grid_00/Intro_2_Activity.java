...
public class Intro_2_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        return_back = (Button) findViewById(R.id.intro_2_return);
        play = (Button) findViewById(R.id.intro_2_play);
        next = (Button) findViewById(R.id.intro_2_next);
